...
const UserPrivacyAndSecuritySettingsBlockedUsersHeader = () => {
  // actions
    ...
    <header className="flex w-full justify-between items-center text-[#919191] sticky top-0 bg-[#212121] z-123123123 p-2">
      <div className="flex items-center justify-center gap-3">
        ...
        <h1 className="text-white font-medium text-xl">
          {t("settings.privacyAndSecurity.blockedUsers")}
        </h1>
      </div>
    </header>
  );
};
export default UserPrivacyAndSecuritySettingsBlockedUsersHeader;