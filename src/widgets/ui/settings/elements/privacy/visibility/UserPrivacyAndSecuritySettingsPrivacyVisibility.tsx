...
const UserPrivacyAndSecuritySettingsPrivacyVisibility: FC<Props> = ({
  field,
  data,
}) => {
  ...
  return (
    <div className="z-1233 flex flex-col h-screen text-white w-full">
      <motion.div
...
export default UserPrivacyAndSecuritySettingsPrivacyVisibility;
