...
interface IUserEdtirProfileSettingsChangeNames {
  firstName: string;
  lastName: string;
  onChange: (v: { firstName?: string; lastName?: string }) => void;
}

const UserEdtirProfileSettingsChangeNames: FC<
  IUserEdtirProfileSettingsChangeNames
...
export default UserEdtirProfileSettingsChangeNames;
