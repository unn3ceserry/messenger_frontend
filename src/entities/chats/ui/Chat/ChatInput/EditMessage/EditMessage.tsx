...
const EditMessage = () => {
  ...
  return (
    <div className="flex w-full p-1 items-center justify-between gap-3">
      ...
      <div className="flex flex-col items-start justify-center w-full min-w-0 bg-blue-400/10 rounded-sm p-0.5 px-2 border-l-[3px] border-l-blue-400">
        <p className="text-[.85rem] text-blue-400">{t("chat.editing")}</p>

        <p className="text-[.75rem] truncate break-all max-w-full">
          {editingMessage.text}
        </p>
      </div>
